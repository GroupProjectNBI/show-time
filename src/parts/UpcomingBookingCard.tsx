            ...
            <div className="mt-4 flex flex-col gap-2 sm:flex-row sm:items-center">
              ...
              {onCancel && (
                <button
                  type="button"
                  onClick={onCancel}
                  disabled={cancelDisabled} // att man inte får avboka för nära inpå 
                  className="inline-flex items-center justify-center gap-2 rounded-full bg-white/5 px-4 py-2 text-sm font-semibold text-accent ring-1 ring-white/10 transition hover:bg-white/10 hover:ring-white/20 disabled:cursor-not-allowed disabled:opacity-50"
                >
                  <X size={16} />
                  Avboka
                </button>
